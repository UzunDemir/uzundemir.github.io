...
![image](https://github.com/UzunDemir/uzundemir.github.io/assets/94790150/17166d7d-cce3-4aa5-aa96-956de49eff89)
...
Таким образом, на этом примере вы узнали как формировать запросы для GPT для быстрого и углубленного изучения материала.
