...
Как цифровизация изменила борьбу с мошенничеством (и почему ложные блокировки — большая проблема)
Финтех и онлайн-платежи стали неотъемлемой частью жизни — мы все чаще платим картой, телефоном или через интернет. Это быстро, удобно и безопасно (особенно после пандемии). По данным Mastercard, в 2020 году 80% их клиентов по всему миру хотя бы раз использовали бесконтактную оплату.
...
Данных много, но вручную их не разгрести
Каждую секунду через Visa проходит 75 000 транзакций. Банки, маркетплейсы и платежные системы копят огромные массивы данных, но анализировать их вручную невозможно. Поэтому компании внедряют системы на основе Big Data и машинного обучения, которые автоматически выявляют подозрительные операции.
...
Почему ложные блокировки — это дорого и неприятно?
Представьте: вы пытаетесь купить авиабилеты, но банк блокирует платеж. Вам звонят, просят подтвердить операцию, тратят ваше время. А потом выясняется, что это были вы и платеж был легальным.
...
Что делать?
Нужны более точные алгоритмы, которые не просто ловят мошенников, но и минимизируют ложные блокировки. Именно над этим мы и работали.



**Что касается игроков индустрии электронной коммерции**, согласно глобальному исследованию Merchant Risk Council за 2017 год, онлайн-ритейлеры в среднем отклоняют 2,6% заказов, причем как минимум 10% из них следовало бы одобрить. По данным Riskified, ложные срабатывания в этом случае приводят к потере 6% выручки.
...
Мошенничество имеет следующие особенности:  
...
- **Автоматизированный инжиниринг признаков**;
- **Глубокие нейронные сети** для автоматизации решений;
- **Классические ML-алгоритмы** (кластеризация, классификация).

Лишь немногие работы исследуют, как эффективно **комбинировать экспертные знания и ИИ**. Большинство статей фокусируются на:
- Инструментах визуализации данных для экспертов;
- **Explainable AI** (интерпретируемые модели вместо «черных ящиков»);
- **Экспертно-ориентированном инжиниринге признаков**;
- Фильтрации зашумленных данных с помощью экспертных правил.
...
- **Дисбаланс классов**: Мошеннические транзакции составляют <0.5%.  
  **Методы**:  
  - Undersampling;  
