...
### Таблица 1. Категории данных о транзакциях
| Категория данных           | Примеры признаков                                                                 |
|----------------------------|-----------------------------------------------------------------------------------|
| **Профиль клиента**        | Доходы/расходы, геолокация, потребительские предпочтения                         |
| **Профиль мерчанта**       | Категория мерчанта, оборот, методы оплаты                                        |
| **ML-скоринги риска**      | Надежность мерчанта, склонность клиента к операциям в определенных категориях    |
| **Кросс-продуктовые атрибуты** | Данные из мобильного приложения, кредитные скоринги, черные списки мерчантов |
